...
public class MailUtil {
	...
	public void sendMail(String userEmail, String emailMsg) throws Exception {
        ...
        props.setProperty("mail.host", "smtp.qq.com"); //smtp.qq.com为SMTP服务器地址，为指定这个服务器发送邮件
        props.setProperty("mail.smtp.auth", "true"); // 指定验证为true
        
        // 创建验证器
        Authenticator auth = new Authenticator() {
        	public PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("1727408125@qq.com", "rjjdxcfqlecoehji"); //参数分别为：用户名和授权密码
			}
        };
        ...
        // 真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("1727408125@qq.com", "星", "UTF-8"));  
